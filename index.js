...
client.on('messageCreate', async message => {
  if (message.content.startsWith(prefix + `stock_member`)) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription('<:members:1220412896950091826> ** My Stock is ** ' + alld.length) 
      .setImage('https://media.discordapp.net/attachments/1220370611285659788/1220469059355934821/mGHXi2pg_-_Copie_2.png')
